...
public class BrickletLCD20x4 extends Device {
	...
	public BrickletLCD20x4(String uid) {
		...
		expectedName = "LCD 20x4 Bricklet";
	...
	public void writeLine(short line, short position, String text)  {
		ByteBuffer bb = IPConnection.createRequestBuffer((byte)stackID, FUNCTION_WRITE_LINE, (short)26);
		bb.put((byte)line);
	 ...
	 * {@link BrickletLCD20x4.writeLine}.
	 * 
	...
	/**
	 * Returns the configuration as set by {@link BrickletLCD20x4.setConfig}.
	 */
